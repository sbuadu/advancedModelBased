...
static const char * c4_debug_family_names[18] = { "L", "M", "m", "b", "k", "g",
  "nargin", "nargout", "C", "u", "w", "f", "x", "x_dot", "theta", "theta_dot",
  "x_dotdot", "theta_dotdot" };

/* Function Declarations */
static void initialize_c4_Model_kalmanTest(SFc4_Model_kalmanTestInstanceStruct
  *chartInstance);
static void initialize_params_c4_Model_kalmanTest
  (SFc4_Model_kalmanTestInstanceStruct *chartInstance);
static void enable_c4_Model_kalmanTest(SFc4_Model_kalmanTestInstanceStruct
  *chartInstance);
static void disable_c4_Model_kalmanTest(SFc4_Model_kalmanTestInstanceStruct
  *chartInstance);
static void c4_update_debugger_state_c4_Model_kalmanTest
  (SFc4_Model_kalmanTestInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c4_Model_kalmanTest
  (SFc4_Model_kalmanTestInstanceStruct *chartInstance);
static void set_sim_state_c4_Model_kalmanTest
  (SFc4_Model_kalmanTestInstanceStruct *chartInstance, const mxArray *c4_st);
static void finalize_c4_Model_kalmanTest(SFc4_Model_kalmanTestInstanceStruct
  *chartInstance);
static void sf_gateway_c4_Model_kalmanTest(SFc4_Model_kalmanTestInstanceStruct
  *chartInstance);
static void mdl_start_c4_Model_kalmanTest(SFc4_Model_kalmanTestInstanceStruct
  *chartInstance);
static void initSimStructsc4_Model_kalmanTest
  (SFc4_Model_kalmanTestInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c4_machineNumber, uint32_T
  c4_chartNumber, uint32_T c4_instanceNumber);
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData);
static real_T c4_emlrt_marshallIn(SFc4_Model_kalmanTestInstanceStruct
  *chartInstance, const mxArray *c4_b_theta_dotdot, const char_T *c4_identifier);
static real_T c4_b_emlrt_marshallIn(SFc4_Model_kalmanTestInstanceStruct
...
static real_T c4_mpower(SFc4_Model_kalmanTestInstanceStruct *chartInstance,
  real_T c4_a);
static void c4_eml_scalar_eg(SFc4_Model_kalmanTestInstanceStruct *chartInstance);
static const mxArray *c4_c_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static int32_T c4_c_emlrt_marshallIn(SFc4_Model_kalmanTestInstanceStruct
  *chartInstance, const mxArray *c4_b_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static uint8_T c4_d_emlrt_marshallIn(SFc4_Model_kalmanTestInstanceStruct
  *chartInstance, const mxArray *c4_b_is_active_c4_Model_kalmanTest, const
  char_T *c4_identifier);
static uint8_T c4_e_emlrt_marshallIn(SFc4_Model_kalmanTestInstanceStruct
  *chartInstance, const mxArray *c4_b_u, const emlrtMsgIdentifier *c4_parentId);
static void init_dsm_address_info(SFc4_Model_kalmanTestInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc4_Model_kalmanTestInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c4_is_active_c4_Model_kalmanTest = 0U;
}
  ...
  (SFc4_Model_kalmanTestInstanceStruct *chartInstance, const mxArray *c4_st)
{
  ...
  *chartInstance->c4_theta_dotdot = c4_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c4_b_u, 0)), "theta_dotdot");
  *chartInstance->c4_x_dotdot = c4_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c4_b_u, 1)), "x_dotdot");
  chartInstance->c4_is_active_c4_Model_kalmanTest = c4_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c4_b_u, 2)),
     "is_active_c4_Model_kalmanTest");
  sf_mex_destroy(&c4_b_u);
  c4_update_debugger_state_c4_Model_kalmanTest(chartInstance);
  ...
  *chartInstance)
{
  ...
  real_T c4_b_x_dotdot;
  real_T c4_b_theta_dotdot;
  real_T c4_c_x;
  real_T c4_d_x;
  real_T c4_e_x;
  real_T c4_f_x;
  ...
  for (c4_i0 = 0; c4_i0 < 6; c4_i0++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c4_C)[c4_i0], 0U);
  }

  _SFD_DATA_RANGE_CHECK(*chartInstance->c4_u, 1U);
  chartInstance->c4_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 3U, chartInstance->c4_sfEvent);
  c4_hoistedGlobal = *chartInstance->c4_u;
  c4_b_hoistedGlobal = *chartInstance->c4_w;
  c4_c_hoistedGlobal = *chartInstance->c4_f;
  c4_d_hoistedGlobal = *chartInstance->c4_x;
  c4_e_hoistedGlobal = *chartInstance->c4_x_dot;
  c4_f_hoistedGlobal = *chartInstance->c4_theta;
  c4_g_hoistedGlobal = *chartInstance->c4_theta_dot;
  for (c4_i1 = 0; c4_i1 < 6; c4_i1++) {
    c4_b_C[c4_i1] = (*chartInstance->c4_C)[c4_i1];
  }

  c4_b_u = c4_hoistedGlobal;
  c4_b_w = c4_b_hoistedGlobal;
  c4_b_f = c4_c_hoistedGlobal;
  c4_b_x = c4_d_hoistedGlobal;
  c4_b_x_dot = c4_e_hoistedGlobal;
  c4_b_theta = c4_f_hoistedGlobal;
  c4_b_theta_dot = c4_g_hoistedGlobal;
  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 18U, 18U, c4_debug_family_names,
    c4_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_L, 0U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_M, 1U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_m, 2U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_b, 3U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_k, 4U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_g, 5U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_nargout, 7U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c4_b_C, 8U, c4_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c4_b_u, 9U, c4_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c4_b_w, 10U, c4_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c4_b_f, 11U, c4_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c4_b_x, 12U, c4_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c4_b_x_dot, 13U, c4_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c4_b_theta, 14U, c4_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c4_b_theta_dot, 15U, c4_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_b_x_dotdot, 16U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_b_theta_dotdot, 17U,
  ...
  c4_A = ((((((c4_b_u - c4_b_f) - c4_b_w) + c4_b_f * c4_mpower(chartInstance,
              c4_d_x)) + c4_m * c4_L * c4_mpower(chartInstance, c4_b_theta_dot) *
            c4_f_x) - c4_m * c4_g * c4_h_x * c4_j_x) - c4_b * c4_b_x_dot) - c4_k
    * c4_b_x;
  c4_B = c4_M + c4_m * c4_mpower(chartInstance, c4_l_x);
  c4_m_x = c4_A;
  c4_y = c4_B;
  c4_n_x = c4_m_x;
  c4_b_y = c4_y;
  ...
  c4_c_A = (((((-c4_b_u * c4_q_x + c4_b_w * c4_s_x) - c4_M * c4_L * c4_mpower
               (chartInstance, c4_b_theta_dot) * c4_u_x * c4_w_x) + (c4_m + c4_M)
              * c4_g * c4_y_x) - c4_g_y * c4_b_f * c4_eb_x) + c4_b * c4_b_x_dot *
            c4_gb_x) + c4_k * c4_b_x * c4_ib_x;
  c4_c_B = c4_L * (c4_M + c4_m * c4_mpower(chartInstance, c4_kb_x));
  c4_lb_x = c4_c_A;
  c4_h_y = c4_c_B;
  c4_mb_x = c4_lb_x;
  c4_i_y = c4_h_y;
  c4_nb_x = c4_mb_x;
  c4_j_y = c4_i_y;
  c4_b_theta_dotdot = c4_nb_x / c4_j_y;
  _SFD_EML_CALL(0U, chartInstance->c4_sfEvent, -17);
  _SFD_SYMBOL_SCOPE_POP();
  *chartInstance->c4_x_dotdot = c4_b_x_dotdot;
  *chartInstance->c4_theta_dotdot = c4_b_theta_dotdot;
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 3U, chartInstance->c4_sfEvent);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_Model_kalmanTestMachineNumber_,
    chartInstance->chartNumber, chartInstance->instanceNumber);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c4_x_dotdot, 2U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c4_w, 3U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c4_f, 4U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c4_x, 5U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c4_x_dot, 6U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c4_theta, 7U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c4_theta_dot, 8U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c4_theta_dotdot, 9U);
}
...
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData)
{
  ...
  const mxArray *c4_y = NULL;
  SFc4_Model_kalmanTestInstanceStruct *chartInstance;
  chartInstance = (SFc4_Model_kalmanTestInstanceStruct *)chartInstanceVoid;
  ...
  *chartInstance, const mxArray *c4_b_theta_dotdot, const char_T *c4_identifier)
{
  ...
  c4_y = c4_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c4_b_theta_dotdot),
    &c4_thisId);
  sf_mex_destroy(&c4_b_theta_dotdot);
  return c4_y;
}
...
static void c4_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData)
{
  const mxArray *c4_b_theta_dotdot;
  const char_T *c4_identifier;
  emlrtMsgIdentifier c4_thisId;
  real_T c4_y;
  SFc4_Model_kalmanTestInstanceStruct *chartInstance;
  chartInstance = (SFc4_Model_kalmanTestInstanceStruct *)chartInstanceVoid;
  c4_b_theta_dotdot = sf_mex_dup(c4_mxArrayInData);
  ...
  *c4_inData)
{
  ...
  for (c4_i2 = 0; c4_i2 < 6; c4_i2++) {
    c4_b_inData[c4_i2] = (*(real_T (*)[6])c4_inData)[c4_i2];
  }

  for (c4_i3 = 0; c4_i3 < 6; c4_i3++) {
    c4_b_u[c4_i3] = c4_b_inData[c4_i3];
  }
...
const mxArray *sf_c4_Model_kalmanTest_get_eml_resolved_functions_info(void)
{
...
static void c4_info_helper(const mxArray **c4_info)
{
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("mpower"), "name", "name", 2);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 2);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m"), "context",
                  "context", 4);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("ismatrix"), "name", "name", 4);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 4);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m"), "context",
                  "context", 5);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("power"), "name", "name", 5);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 5);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m!fltpower"), "context",
                  "context", 11);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("floor"), "name", "name", 11);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 11);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
  ...
  *chartInstance, const mxArray *c4_b_u, const emlrtMsgIdentifier *c4_parentId)
{
  ...
  int32_T c4_i4;
  (void)chartInstance;
  sf_mex_import(c4_parentId, sf_mex_dup(c4_b_u), &c4_i4, 1, 6, 0U, 0, 0U, 0);
  c4_y = c4_i4;
  sf_mex_destroy(&c4_b_u);
  return c4_y;
}
  ...
  char_T *c4_identifier)
{
  ...
  c4_y = c4_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c4_b_is_active_c4_Model_kalmanTest), &c4_thisId);
  sf_mex_destroy(&c4_b_is_active_c4_Model_kalmanTest);
  return c4_y;
}
...
static void init_simulink_io_address(SFc4_Model_kalmanTestInstanceStruct
  *chartInstance)
{
  chartInstance->c4_C = (real_T (*)[6])ssGetInputPortSignal_wrapper
    (chartInstance->S, 0);
  chartInstance->c4_u = (real_T *)ssGetInputPortSignal_wrapper(chartInstance->S,
    1);
  chartInstance->c4_x_dotdot = (real_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 1);
  chartInstance->c4_w = (real_T *)ssGetInputPortSignal_wrapper(chartInstance->S,
    2);
  chartInstance->c4_f = (real_T *)ssGetInputPortSignal_wrapper(chartInstance->S,
    3);
  chartInstance->c4_x = (real_T *)ssGetInputPortSignal_wrapper(chartInstance->S,
    4);
  chartInstance->c4_x_dot = (real_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 5);
  chartInstance->c4_theta = (real_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 6);
  chartInstance->c4_theta_dot = (real_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 7);
  chartInstance->c4_theta_dotdot = (real_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 2);
}
...
void sf_c4_Model_kalmanTest_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3176848963U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1866378080U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(4066425186U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3306313341U);
}

mxArray* sf_c4_Model_kalmanTest_get_post_codegen_info(void);
mxArray *sf_c4_Model_kalmanTest_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("KJ7WYei7pWoMZafeqGWcpD");
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c4_Model_kalmanTest_get_post_codegen_info();
...
mxArray *sf_c4_Model_kalmanTest_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c4_Model_kalmanTest_jit_fallback_info(void)
{
...
mxArray *sf_c4_Model_kalmanTest_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c4_Model_kalmanTest(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[13],T\"theta_dotdot\",},{M[1],M[5],T\"x_dotdot\",},{M[8],M[0],T\"is_active_c4_Model_kalmanTest\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c4_Model_kalmanTest_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc4_Model_kalmanTestInstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          _SFD_SET_DATA_PROPS(2,2,0,1,"x_dotdot");
          ...
          _SFD_SET_DATA_PROPS(8,1,1,0,"theta_dot");
          _SFD_SET_DATA_PROPS(9,2,0,1,"theta_dotdot");
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,694);
        ...
        _SFD_SET_DATA_COMPILED_PROPS(9,SF_DOUBLE,0,NULL,0,0,0,0.0,1.0,0,0,
          (MexFcnForType)c4_sf_marshallOut,(MexInFcnForType)c4_sf_marshallIn);
        _SFD_SET_DATA_VALUE_PTR(0U, *chartInstance->c4_C);
        _SFD_SET_DATA_VALUE_PTR(1U, chartInstance->c4_u);
        _SFD_SET_DATA_VALUE_PTR(2U, chartInstance->c4_x_dotdot);
        _SFD_SET_DATA_VALUE_PTR(3U, chartInstance->c4_w);
        _SFD_SET_DATA_VALUE_PTR(4U, chartInstance->c4_f);
        _SFD_SET_DATA_VALUE_PTR(5U, chartInstance->c4_x);
        _SFD_SET_DATA_VALUE_PTR(6U, chartInstance->c4_x_dot);
        _SFD_SET_DATA_VALUE_PTR(7U, chartInstance->c4_theta);
        _SFD_SET_DATA_VALUE_PTR(8U, chartInstance->c4_theta_dot);
        _SFD_SET_DATA_VALUE_PTR(9U, chartInstance->c4_theta_dotdot);
      }
    } else {
...
{
  return "GKsPEmantSoy9iHiVPRmeF";
}

static void sf_opaque_initialize_c4_Model_kalmanTest(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc4_Model_kalmanTestInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c4_Model_kalmanTest((SFc4_Model_kalmanTestInstanceStruct*)
    chartInstanceVar);
  initialize_c4_Model_kalmanTest((SFc4_Model_kalmanTestInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c4_Model_kalmanTest(void *chartInstanceVar)
{
  enable_c4_Model_kalmanTest((SFc4_Model_kalmanTestInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c4_Model_kalmanTest(void *chartInstanceVar)
{
  disable_c4_Model_kalmanTest((SFc4_Model_kalmanTestInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c4_Model_kalmanTest(void *chartInstanceVar)
{
  sf_gateway_c4_Model_kalmanTest((SFc4_Model_kalmanTestInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c4_Model_kalmanTest(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c4_Model_kalmanTest((SFc4_Model_kalmanTestInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c4_Model_kalmanTest(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c4_Model_kalmanTest((SFc4_Model_kalmanTestInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c4_Model_kalmanTest(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc4_Model_kalmanTestInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c4_Model_kalmanTest((SFc4_Model_kalmanTestInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc4_Model_kalmanTest((SFc4_Model_kalmanTestInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c4_Model_kalmanTest(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c4_Model_kalmanTest(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(1869247984U));
  ssSetChecksum1(S,(3720719586U));
  ssSetChecksum2(S,(3975062025U));
  ssSetChecksum3(S,(2095427471U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c4_Model_kalmanTest(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c4_Model_kalmanTest(SimStruct *S)
{
  SFc4_Model_kalmanTestInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc4_Model_kalmanTestInstanceStruct *)utMalloc(sizeof
    (SFc4_Model_kalmanTestInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc4_Model_kalmanTestInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c4_Model_kalmanTest;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c4_Model_kalmanTest;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c4_Model_kalmanTest;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c4_Model_kalmanTest;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c4_Model_kalmanTest;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c4_Model_kalmanTest;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c4_Model_kalmanTest;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c4_Model_kalmanTest;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c4_Model_kalmanTest;
  chartInstance->chartInfo.mdlStart = mdlStart_c4_Model_kalmanTest;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c4_Model_kalmanTest;
...
void c4_Model_kalmanTest_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c4_Model_kalmanTest(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c4_Model_kalmanTest(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c4_Model_kalmanTest(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c4_Model_kalmanTest_method_dispatcher.\n"
