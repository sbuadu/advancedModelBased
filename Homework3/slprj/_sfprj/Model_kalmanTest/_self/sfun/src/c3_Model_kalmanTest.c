...
static void initialize_c3_Model_kalmanTest(SFc3_Model_kalmanTestInstanceStruct
  *chartInstance);
static void initialize_params_c3_Model_kalmanTest
  (SFc3_Model_kalmanTestInstanceStruct *chartInstance);
static void enable_c3_Model_kalmanTest(SFc3_Model_kalmanTestInstanceStruct
  *chartInstance);
static void disable_c3_Model_kalmanTest(SFc3_Model_kalmanTestInstanceStruct
  *chartInstance);
static void c3_update_debugger_state_c3_Model_kalmanTest
  (SFc3_Model_kalmanTestInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c3_Model_kalmanTest
  (SFc3_Model_kalmanTestInstanceStruct *chartInstance);
static void set_sim_state_c3_Model_kalmanTest
  (SFc3_Model_kalmanTestInstanceStruct *chartInstance, const mxArray *c3_st);
static void finalize_c3_Model_kalmanTest(SFc3_Model_kalmanTestInstanceStruct
  *chartInstance);
static void sf_gateway_c3_Model_kalmanTest(SFc3_Model_kalmanTestInstanceStruct
  *chartInstance);
static void mdl_start_c3_Model_kalmanTest(SFc3_Model_kalmanTestInstanceStruct
  *chartInstance);
static void initSimStructsc3_Model_kalmanTest
  (SFc3_Model_kalmanTestInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c3_machineNumber, uint32_T
  c3_chartNumber, uint32_T c3_instanceNumber);
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData);
static real_T c3_emlrt_marshallIn(SFc3_Model_kalmanTestInstanceStruct
  *chartInstance, const mxArray *c3_b_theta_dotdot, const char_T *c3_identifier);
static real_T c3_b_emlrt_marshallIn(SFc3_Model_kalmanTestInstanceStruct
...
static const mxArray *c3_c_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static int32_T c3_c_emlrt_marshallIn(SFc3_Model_kalmanTestInstanceStruct
  *chartInstance, const mxArray *c3_b_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static uint8_T c3_d_emlrt_marshallIn(SFc3_Model_kalmanTestInstanceStruct
  *chartInstance, const mxArray *c3_b_is_active_c3_Model_kalmanTest, const
  char_T *c3_identifier);
static uint8_T c3_e_emlrt_marshallIn(SFc3_Model_kalmanTestInstanceStruct
  *chartInstance, const mxArray *c3_b_u, const emlrtMsgIdentifier *c3_parentId);
static void init_dsm_address_info(SFc3_Model_kalmanTestInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc3_Model_kalmanTestInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c3_is_active_c3_Model_kalmanTest = 0U;
}
  ...
  (SFc3_Model_kalmanTestInstanceStruct *chartInstance)
{
  ...
  c3_b_hoistedGlobal = chartInstance->c3_is_active_c3_Model_kalmanTest;
  ...
  (SFc3_Model_kalmanTestInstanceStruct *chartInstance, const mxArray *c3_st)
{
  ...
  *chartInstance->c3_theta_dotdot = c3_emlrt_marshallIn(chartInstance,
  ...
  chartInstance->c3_is_active_c3_Model_kalmanTest = c3_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c3_b_u, 1)),
     "is_active_c3_Model_kalmanTest");
  sf_mex_destroy(&c3_b_u);
  c3_update_debugger_state_c3_Model_kalmanTest(chartInstance);
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  const mxArray *c3_y = NULL;
  SFc3_Model_kalmanTestInstanceStruct *chartInstance;
  chartInstance = (SFc3_Model_kalmanTestInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c3_Model_kalmanTest_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c3_identifier)
{
  ...
  c3_y = c3_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c3_b_is_active_c3_Model_kalmanTest), &c3_thisId);
  sf_mex_destroy(&c3_b_is_active_c3_Model_kalmanTest);
  return c3_y;
}
...
void sf_c3_Model_kalmanTest_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c3_Model_kalmanTest_get_post_codegen_info(void);
mxArray *sf_c3_Model_kalmanTest_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c3_Model_kalmanTest_get_post_codegen_info();
...
mxArray *sf_c3_Model_kalmanTest_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c3_Model_kalmanTest_jit_fallback_info(void)
{
...
mxArray *sf_c3_Model_kalmanTest_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c3_Model_kalmanTest(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[12],T\"theta_dotdot\",},{M[8],M[0],T\"is_active_c3_Model_kalmanTest\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_Model_kalmanTest_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc3_Model_kalmanTestInstanceStruct *)
...
static void sf_opaque_initialize_c3_Model_kalmanTest(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc3_Model_kalmanTestInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c3_Model_kalmanTest((SFc3_Model_kalmanTestInstanceStruct*)
    chartInstanceVar);
  initialize_c3_Model_kalmanTest((SFc3_Model_kalmanTestInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c3_Model_kalmanTest(void *chartInstanceVar)
{
  enable_c3_Model_kalmanTest((SFc3_Model_kalmanTestInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c3_Model_kalmanTest(void *chartInstanceVar)
{
  disable_c3_Model_kalmanTest((SFc3_Model_kalmanTestInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c3_Model_kalmanTest(void *chartInstanceVar)
{
  sf_gateway_c3_Model_kalmanTest((SFc3_Model_kalmanTestInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c3_Model_kalmanTest(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c3_Model_kalmanTest((SFc3_Model_kalmanTestInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c3_Model_kalmanTest(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c3_Model_kalmanTest((SFc3_Model_kalmanTestInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c3_Model_kalmanTest(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_Model_kalmanTestInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c3_Model_kalmanTest((SFc3_Model_kalmanTestInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc3_Model_kalmanTest((SFc3_Model_kalmanTestInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_Model_kalmanTest(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c3_Model_kalmanTest(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c3_Model_kalmanTest(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_Model_kalmanTest(SimStruct *S)
{
  SFc3_Model_kalmanTestInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc3_Model_kalmanTestInstanceStruct *)utMalloc(sizeof
    (SFc3_Model_kalmanTestInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc3_Model_kalmanTestInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c3_Model_kalmanTest;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c3_Model_kalmanTest;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c3_Model_kalmanTest;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c3_Model_kalmanTest;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c3_Model_kalmanTest;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c3_Model_kalmanTest;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c3_Model_kalmanTest;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c3_Model_kalmanTest;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c3_Model_kalmanTest;
  chartInstance->chartInfo.mdlStart = mdlStart_c3_Model_kalmanTest;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c3_Model_kalmanTest;
...
void c3_Model_kalmanTest_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_Model_kalmanTest(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_Model_kalmanTest(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_Model_kalmanTest(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_Model_kalmanTest_method_dispatcher.\n"
