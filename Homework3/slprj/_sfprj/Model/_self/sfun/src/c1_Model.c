...
static real_T c1_emlrt_marshallIn(SFc1_ModelInstanceStruct *chartInstance, const
  mxArray *c1_b_x_dotdot, const char_T *c1_identifier);
static real_T c1_b_emlrt_marshallIn(SFc1_ModelInstanceStruct *chartInstance,
...
static const mxArray *c1_c_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int32_T c1_c_emlrt_marshallIn(SFc1_ModelInstanceStruct *chartInstance,
  const mxArray *c1_b_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static uint8_T c1_d_emlrt_marshallIn(SFc1_ModelInstanceStruct *chartInstance,
  ...
  *chartInstance)
{
  ...
  c1_b_hoistedGlobal = chartInstance->c1_is_active_c1_Model;
  ...
  const mxArray *c1_st)
{
  ...
  *chartInstance->c1_x_dotdot = c1_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c1_is_active_c1_Model = c1_d_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c1_b_u, 1)), "is_active_c1_Model");
  ...
  const mxArray *c1_b_is_active_c1_Model, const char_T *c1_identifier)
{
  ...
  c1_thisId.fIdentifier = c1_identifier;
  c1_thisId.fParent = NULL;
  c1_y = c1_e_emlrt_marshallIn(chartInstance, sf_mex_dup(c1_b_is_active_c1_Model),
    &c1_thisId);
...
mxArray* sf_c1_Model_get_post_codegen_info(void);
mxArray *sf_c1_Model_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c1_Model_get_post_codegen_info();
...
static const mxArray *sf_get_sim_state_info_c1_Model(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[12],T\"x_dotdot\",},{M[8],M[0],T\"is_active_c1_Model\",}}"
  };
...
static void sf_opaque_set_sim_state_c1_Model(SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c1_Model((SFc1_ModelInstanceStruct*)chartInfo->chartInstance, st);
}
